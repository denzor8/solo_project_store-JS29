						...
						<div className='details__content'>
							<div className='details__card'>
								<div className="details__content-containter">
									<div className='details__name-category'>
										<div><h3 className="details__content-title">{productDetails.name}</h3></div>
										<div><b className="">Type:</b> {productDetails.type}
											{/*  можно будет сделать так чтобы он мог перейти по ссылке категории и покажет base с этой же категорией  */}
										</div>
									</div>
									...
									<div className='details__basket'>
										<div className='details__basket-ctn'>
											<div className="details__basket-favorite">
